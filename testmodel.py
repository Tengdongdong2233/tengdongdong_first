...
def infer(modelpath='result/TRAINED_ADVERSARIAL.model', no_of_preds = 2):
	"""
	...
	for i in range(4):
		...
		f.savefig("../inference/INPUTS"+str(i)+'.png', tight=True)
	plt.close()
...
if __name__ =="__main__":
	...
	parser.add_argument('--no_pred', '-n', type=int, default=5)
