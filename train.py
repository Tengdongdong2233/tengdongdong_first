...
def main(resume, gpu, load_path, data_path):
	...
	iterator = chainer.iterators.SerialIterator(dataset, 4)
	params = {'LAM_ADV': 0.05, 'LAM_LP': 0, 'LAM_GDL': 1.0, 'LAM_HB': 1}
	...
	trainer = chainer.training.Trainer(updater, (1000, 'iteration'), out='result')
	...
	log_keys = ['epoch', 'iteration', 'GeneratorNetwork/L1Loss', 'GeneratorNetwork/L2Loss', 'GeneratorNetwork/GDL', 'GeneratorNetwork/HuberLoss',
	            'DiscriminatorNetwork/DisLoss', 'GeneratorNetwork/CompositeGenLoss', 'GeneratorNetwork/AdvLoss']
	print_keys = ['GeneratorNetwork/CompositeGenLoss','DiscriminatorNetwork/DisLoss', 'GeneratorNetwork/HuberLoss', 'GeneratorNetwork/GDL', 'GeneratorNetwork/AdvLoss']
	...
	trainer.extend(extensions.PlotReport(['GeneratorNetwork/L1Loss'], 'iteration', (10, 'iteration'), file_name="L1Loss.png"))
	trainer.extend(extensions.PlotReport(['GeneratorNetwork/HuberLoss'], 'iteration', (10, 'iteration'), file_name="HuberLoss.png"))
