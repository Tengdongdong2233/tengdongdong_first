...
LRATE_G = 0.000001 # Value in paper is 0.04
...
#                [3 * (HIST_LEN + 1), 128, 256, 512, 256, 128, 3]]
SCALE_FMS_G = [[3 * HIST_LEN, 64, 64, 128, 128, 256, 3],
               [3 * (HIST_LEN + 1), 64, 128, 256, 256, 128, 3],
               [3 * (HIST_LEN + 1), 64, 128, 128, 256, 256, 128, 128, 3],
               [3 * (HIST_LEN + 1), 64, 128, 128, 256, 256, 128, 128, 3],
               [3 * (HIST_LEN + 1), 64, 128, 128, 256, 256, 128, 128, 3]]
...
#                         [5, 3, 3, 3, 3, 5],
#                         [7, 5, 5, 5, 5, 7]]
SCALE_KERNEL_SIZES_G = [[7, 7, 5, 5, 3, 3],
                        [7, 5, 3, 3, 5, 7],
                        [7, 5, 5, 3, 3, 5, 5, 7],
                        [7, 5, 5, 3, 3, 5, 5, 7],
                        [7, 5, 5, 3, 3, 5, 5, 7]]
